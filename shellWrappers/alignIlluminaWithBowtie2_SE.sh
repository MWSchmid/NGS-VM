#!/bin/bash
#
# alignIlluminaWithBowtie2_SE.sh -- align Illumina reads (SE) with bowtie2
#
...
usage () {
    cat <<__EOF__
Usage:
  $me [options] [INDIR] [OUTDIR] [OUTPREFIX] [FASTQ] [INDEX]
This script aligns Illumina reads (SE) with bowtie2. Only unique alignments are kept.
