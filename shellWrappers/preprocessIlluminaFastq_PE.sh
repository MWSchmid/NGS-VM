...
memory=4
maxMem=4
trimmomatic="$HOME/trimmomatic/trimmomatic-0.33.jar"
adapterSeqs="$HOME/trimmomatic/adapters/TruSeq3-PE.fa"
...
2) trimmomatic: Illumina adapter (TrueSeq3) removal and low quality clipping
...
short_opts='hvt:m:j:a:'
long_opts='help,verbose,threads,memory,jarTrimmomatic,adapterSeqs'
...
command="java -Xmx${maxMem}g -jar ${trimmomatic} PE -threads ${threads} -phred33\
	...
	${outputDir}/${prefix}_R1_paired.tr.fq.gz ${outputDir}/${prefix}_R1_unpaired.tr.fq.gz\
	${outputDir}/${prefix}_R2_paired.tr.fq.gz ${outputDir}/${prefix}_R2_unpaired.tr.fq.gz\
