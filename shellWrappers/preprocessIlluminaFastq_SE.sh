...
adapterSeqs="$HOME/trimmomatic/adapters/TruSeq3-SE.fa"
...
short_opts='hvt:m:dj:a:'
long_opts='help,verbose,threads,memory,remDupReads,jarTrimmomatic,adapterSeqs'
...
command="java -Xmx${maxMem}g -jar ${trimmomatic} SE -threads ${threads} -phred33\
	${inputDir}/${inputFile} ${outputDir}/${prefix}.tr.fq.gz\
